...
|---|---|---|---|
| Contextual | Service-based filter ([Privacy Filter](https://openai.com/index/introducing-openai-privacy-filter/)) | Handles mixed/ambiguous text, names in context, partial addresses | Primary detection for complex real-world content |
